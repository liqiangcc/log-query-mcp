...
| [0007](./0007-support-remote-sources-via-local-cache.md) | Remote Source 通过本地 Cache 接入统一查询引擎 | Accepted for v2 |
| [0008](./0008-use-ssh-sftp-without-remote-exec.md) | Remote Source 仅使用 SSH/SFTP，不提供远程命令执行 | Accepted for v2 |
