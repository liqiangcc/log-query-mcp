...
> 项目处于正式实现阶段。v1 契约已经冻结，当前已完成配置模型、安全来源注册表、有界单文件扫描器和受限阻塞执行器，尚未形成生产发布版本。
...
- [x] M1 v1 契约冻结并合并
- [x] Rust 正式工程和版本化配置模型
- [x] `SafeRoot`、`openat2()` 和有界目录发现
- [x] `SourceRegistry` 与文件身份快照
- [x] 有界单文件字面量扫描器
- [x] `ScanExecutor`、并发限制、deadline 和协作取消
- [ ] 多文件和多来源查询编排
- [ ] 时间过滤与稳定排序
- [ ] MCP Server
